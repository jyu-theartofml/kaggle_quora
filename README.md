...
Log loss is used to evaluate the performance of the model. Two codes are shown in this repository - the first one is the preprocessing step to build the embedding matrix, and the second code is for model training and tuning. The final ranking for this submission was top 37% on Kaggle's LB.</p>
